...
const TEST_PACKAGES: Record<string, TestPackage> = {
  ...
  cbc: {
    ...
    category: "Hematology",
    description:
      "Comprehensive blood analysis including red cells, white cells, platelets and related parameters",
    tests: [
      "rbc",
      "wbc",
      "hemoglobin",
  ...
  "liver-function": {
    ...
    description:
      "Comprehensive liver function tests including enzymes, proteins, and bilirubin",
    tests: [
      "alt",
      "ast",
      "alp",
  ...
  urinalysis: {
    ...
    tests: [
      ...
      "urine-blood",
      "urine-bilirubin",
      "urine-nitrite-leukocyte",
      "urine-24h-creatinine",
    ],
...
const INDIVIDUAL_TESTS: Record<string, TestItem> = {
  ...
  "malaria-parasite": {
    ...
    category: "Hematology",
    material: "Blood",
    snomedCode: "165735001",
  },
  microfilaria: {
    id: "microfilaria",
    name: "Microfilaria Test",
    code: "MICROF",
    category: "Hematology",
    material: "Blood",
    snomedCode: "165736002",
  },
  "iron-studies-hb-electrophoresis": {
    id: "iron-studies-hb-electrophoresis",
    name: "Iron Studies & Hemoglobin Electrophoresis",
    code: "IRON-HB",
    category: "Hematology",
    material: "Blood",
    snomedCode: "165737003",
  },
  "bone-marrow-exam": {
    id: "bone-marrow-exam",
  ...
  "urine-nitrite-leukocyte": {
    id: "urine-nitrite-leukocyte",
    name: "Nitrites & Leukocyte Esterase",
    code: "NIT-LE",
    category: "Biochemistry",
    material: "Urine",
    snomedCode: "165762008",
  ...
  "urine-24h-creatinine": {
    id: "urine-24h-creatinine",
    name: "24-hours Urine Creatinine Clearance",
    code: "24H-CRE",
    category: "Biochemistry",
    material: "Urine",
    snomedCode: "165780001",
  },
  glucose: {
    id: "glucose",
    name: "Glucose",
  ...
  "uti-diagnosis": {
    ...
    category: "Microbiology",
    material: "Urine",
    snomedCode: "165785001",
  },
  "sputum-culture-test": {
    id: "sputum-culture-test",
    name: "Sputum Culture",
    code: "SPUT",
    category: "Microbiology",
    material: "Sputum",
    snomedCode: "165786001",
  },
  "stool-parasites": {
    id: "stool-parasites",
    name: "Parasites",
  ...
  "anti-rnp": {
    ...
    category: "Immunology",
    material: "Blood",
    snomedCode: "165805001",
  },
  "anti-ssa-ssb": {
    id: "anti-ssa-ssb",
    name: "Anti-SSA / Anti-SSB",
    code: "ANTI-SSA-SSB",
    category: "Immunology",
    material: "Blood",
    snomedCode: "165806001",
  },
  anca: {
    id: "anca",
    name: "ANCA",
  ...
  ama: {
    ...
    category: "Immunology",
    material: "Blood",
    snomedCode: "165808001",
  },
  "anti-tpo-thyroglobulin": {
    id: "anti-tpo-thyroglobulin",
    name: "Anti-TPO & Anti-Thyroglobulin",
    code: "ANTI-TPO-TG",
    category: "Immunology",
    material: "Blood",
    snomedCode: "165809001",
  },
  ...
  "total-ige": {
    ...
    category: "Immunology",
    material: "Blood",
    snomedCode: "165810001",
  },
  "allergen-specific-ige": {
    id: "allergen-specific-ige",
    name: "Allergen-specific IgE",
    code: "SPEC-IGE",
    category: "Immunology",
    material: "Blood",
    snomedCode: "165811001",
  },
  "skin-prick-tests": {
    id: "skin-prick-tests",
    name: "Skin Prick Tests",
    code: "SPT",
    category: "Immunology",
    material: "Skin",
    snomedCode: "165812001",
  },
  ...
  ca199: {
    ...
    category: "Immunology",
    material: "Blood",
    snomedCode: "165773009",
  },
  "beta2-glycoprotein-anticardiolipin": {
    id: "beta2-glycoprotein-anticardiolipin",
    name: "Beta-2 glycoprotein & Anticardiolipin antibodies",
    code: "BETA2-ANTI",
    category: "Immunology",
    material: "Blood",
    snomedCode: "165822001",
  },
  ...
  "cervical-cancer-screening": {
    ...
    code: "PAP",
    category: "Histopathology",
    material: "Cervical Cells",
    snomedCode: "165824001",
  },
  fnac: {
    id: "fnac",
    name: "FNAC",
  ...
  fish: {
    ...
    category: "Histopathology",
    material: "Tissue",
    snomedCode: "165831001",
  },
  "genetic-sequencing": {
    id: "genetic-sequencing",
    name: "Genetic Sequencing",
    code: "SEQ",
    category: "Histopathology",
    material: "Tissue/Blood",
    snomedCode: "165832001",
  },
  "urine-cytology": {
    id: "urine-cytology",
    name: "Urine Cytology",
  ...
  "pleural-fluid": {
    ...
    code: "PLEURAL",
    category: "Histopathology",
    material: "Pleural Fluid",
    snomedCode: "165835001",
  },
  "peritoneal-fluid": {
    id: "peritoneal-fluid",
    ...
    code: "PERITONEAL",
    category: "Histopathology",
    material: "Peritoneal Fluid",
    snomedCode: "165836001",
  },
};
...
export default function EnhancedOrdersTab({
  ...
  const onFieldChange = useCallback(
    (field: keyof TestOrderForm, value: string | string[] | undefined) => {
  ...
  const getSelectedTestsDetails = useCallback(() => {
    return formState.selectedTests
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  dispatch({ type: "SET_LAB", labId: e.target.value })
                }
              >
              ...
              {formState.target_lab && LABORATORIES[formState.target_lab] && (
                <div className="mt-3 p-3 bg-gray-50 rounded-md text-sm">
                  <div className="font-medium">
                    {LABORATORIES[formState.target_lab].name}
                  </div>
                  <div className="text-gray-600 mt-1">
                    {LABORATORIES[formState.target_lab].address}
                  </div>
                  <div className="text-gray-600">
                    {LABORATORIES[formState.target_lab].phone}
                  </div>
            ...
            {formState.target_lab && (
              <div className="space-y-4">
                <div>
                  ...
                  {availablePackages.length > 0 && (
                    <p className="text-sm text-blue-600 mt-2">
                      {availablePackages.length} test group
                      {availablePackages.length !== 1 ? "s" : ""} available for{" "}
                      {LABORATORIES[formState.target_lab]?.name}
                    </p>
                  )}
                  {availablePackages.length === 0 && (
                ...
                {formState.selectedPackage &&
                  TEST_PACKAGES[formState.selectedPackage] && (
                    <div className="bg-blue-50 p-4 rounded-lg space-y-3">
                      <div>
                        ...
                        <div className="flex items-center gap-2 mt-2">
                          <Badge variant="outline">
                            {TEST_PACKAGES[formState.selectedPackage].category}
                          </Badge>
                      ...
                      <div className="border-t border-blue-200 pt-3">
                        <div className="flex items-center justify-between mb-3">
                          ...
                          <div className="flex gap-2">
                            <Button
                              ...
                              variant="outline"
                              onClick={() =>
                                dispatch({ type: "SELECT_ALL_TESTS" })
                              }
                              className="text-xs"
                            >
                              Select All
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-2 max-h-64 overflow-y-auto bg-white p-3 rounded border border-blue-200">
                          {TEST_PACKAGES[formState.selectedPackage].tests.map(
                            (testId) => {
                              ...
                              return (
                                ...
                                >
                                  <Checkbox
                                    checked={formState.selectedTests.includes(
                                      testId
                                    )}
                                    onCheckedChange={() =>
                        ...
                        <div className="mt-2 text-sm text-blue-700">
                          <strong>{formState.selectedTests.length}</strong> of{" "}
                          <strong>
                            {
                              TEST_PACKAGES[formState.selectedPackage].tests
                                .length
            ...
            {formState.selectedTests.length > 0 && (
              <div className="bg-muted/30 p-4 rounded-lg">
                ...
                <div className="space-y-2">
                  {Object.entries(getSelectedTestsByCategory()).map(
                    ([category, tests]) => (
                      <div key={category}>
            ...
            <div>
              ...
              <textarea
                ...
                onChange={(e) =>
                  onFieldChange("clinical_indication", e.target.value)
                }
              />
            </div>
