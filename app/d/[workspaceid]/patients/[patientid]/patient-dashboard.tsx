...
export default function PatientDashboard({
  ...
  useEffect(() => {
    ...
    loadLabResults();
    loadImaging();
  }, [loadAppointments, loadVitalSigns, loadVaccinations, loadReferrals, loadPrescriptions, loadTestOrders, loadLabResults, loadImaging]);
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            {vaccinationRecords.length > 0 && (
              <span className="text-xs text-muted-foreground">
                Latest: {new Date(vaccinationRecords[0].recorded_time).toLocaleString('en-US', {
                  month: 'short',
                  day: 'numeric',
                  hour: '2-digit',
                  minute: '2-digit'
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <Button size="sm" onClick={() => setShowVaccinationForm(true)} className="bg-indigo-600 hover:bg-indigo-700">
