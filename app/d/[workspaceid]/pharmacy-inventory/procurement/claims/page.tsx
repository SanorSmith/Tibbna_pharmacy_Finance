  ...
  return (
    <div style={{ padding: '24px', maxWidth: '1400px', margin: '0 auto', marginTop: '8px' }}>
      ...
      <div style={{display:"flex",gap:4,marginBottom:16,background:"#f9fafb",flexWrap:"wrap",borderRadius:8,padding:4,marginTop:16,alignItems:"center"}}>
        ...
        {/* Action Buttons */}
        <button onClick={fetchClaims} style={{padding:"10px",fontSize:13,fontWeight:600,border:"none",background:"#16a34a",cursor:"pointer",color:"#ffffff",borderRadius:9999,margin:"4px 2px",display:"flex",alignItems:"center",gap:6,justifyContent:"center",width:"40px",height:"40px"}}>🔄</button>
