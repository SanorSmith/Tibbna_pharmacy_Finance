...
// Comprehensive medical reference data based on standard clinical guidelines
const medicalData: MedicalReferenceData[] = [
  ...
  { testcode: "TG", bodysite: "Venous blood", referencemin: "3", referencemax: "40", clinicalindication: "Monitoring thyroid cancer recurrence post-thyroidectomy", agegroup: "ADULT", sex: "ANY" },
  { testcode: "TGA", bodysite: "Venous blood", referencetext: "< 4.0 IU/mL", clinicalindication: "Autoimmune thyroid disease; Hashimoto's thyroiditis", agegroup: "ADULT", sex: "ANY" },
  { testcode: "ATPO", bodysite: "Venous blood", referencetext: "< 35 IU/mL", clinicalindication: "Autoimmune thyroid disorders; Graves' disease; Hashimoto's thyroiditis", agegroup: "ADULT", sex: "ANY" },
  
  // Endocrinology - Fertility Hormones
  ...
  { testcode: "E2", bodysite: "Venous blood", referencemin: "30", referencemax: "400", clinicalindication: "Ovarian function; menstrual disorders; IVF monitoring", agegroup: "ADULT", sex: "F" },
  { testcode: "PRG", bodysite: "Venous blood", referencemin: "0.2", referencemax: "25.0", clinicalindication: "Ovulation confirmation; luteal phase assessment; pregnancy monitoring", agegroup: "ADULT", sex: "F" },
  ...
  { testcode: "β-HCG", bodysite: "Venous blood", referencetext: "< 5 mIU/mL", clinicalindication: "Pregnancy confirmation; ectopic pregnancy; trophoblastic disease", agegroup: "ADULT", sex: "F" },
  { testcode: "AMH", bodysite: "Venous blood", referencemin: "1.0", referencemax: "4.0", clinicalindication: "Ovarian reserve assessment; PCOS diagnosis", agegroup: "ADULT", sex: "F" },
  
  // Endocrinology - Adrenal & Bone
  { testcode: "ACTH", bodysite: "Venous blood", referencemin: "10", referencemax: "60", paniclow: "5", panichigh: "100", clinicalindication: "Cushing's syndrome; Addison's disease; adrenal insufficiency", agegroup: "ADULT", sex: "ANY" },
  { testcode: "Cortisol", bodysite: "Venous blood", referencemin: "6.2", referencemax: "19.4", paniclow: "2.0", panichigh: "50.0", clinicalindication: "Cushing's syndrome; adrenal insufficiency; stress response", agegroup: "ADULT", sex: "ANY" },
  { testcode: "PTH", bodysite: "Venous blood", referencemin: "15", referencemax: "65", paniclow: "5", panichigh: "200", clinicalindication: "Hypercalcemia; hypocalcemia; parathyroid disorders", agegroup: "ADULT", sex: "ANY" },
  { testcode: "VitD3", bodysite: "Venous blood", referencemin: "30", referencemax: "100", paniclow: "10", panichigh: "150", clinicalindication: "Vitamin D deficiency; osteoporosis; rickets; bone health", agegroup: "ADULT", sex: "ANY" },
  ...
  { testcode: "C-P", bodysite: "Venous blood", referencemin: "0.9", referencemax: "7.1", clinicalindication: "Insulin production assessment; diabetes classification", agegroup: "ADULT", sex: "ANY" },
  { testcode: "INS", bodysite: "Venous blood", referencemin: "2.6", referencemax: "24.9", clinicalindication: "Hypoglycemia; insulin resistance; insulinoma", agegroup: "ADULT", sex: "ANY" },
  ...
  { testcode: "Toxo IgM", bodysite: "Venous blood", referencetext: "Negative", clinicalindication: "Acute toxoplasmosis; congenital infection risk", agegroup: "ADULT", sex: "ANY" },
  ...
  { testcode: "CMV IgM", bodysite: "Venous blood", referencetext: "Negative", clinicalindication: "Acute CMV infection; congenital CMV", agegroup: "ADULT", sex: "ANY" },
  ...
  { testcode: "Rubella IgM", bodysite: "Venous blood", referencetext: "Negative", clinicalindication: "Acute rubella infection; congenital rubella syndrome", agegroup: "ADULT", sex: "ANY" },
  ...
  { testcode: "HBs Ag screen", bodysite: "Venous blood", referencetext: "Negative", clinicalindication: "Hepatitis B screening; blood donor screening", agegroup: "ADULT", sex: "ANY" },
  { testcode: "HBs Ab IgG", bodysite: "Venous blood", referencetext: "> 10 mIU/mL (Immune)", clinicalindication: "HBV immunity; vaccination response", agegroup: "ADULT", sex: "ANY" },
  ...
  { testcode: "HCV screen", bodysite: "Venous blood", referencetext: "Negative", clinicalindication: "HCV screening; blood donor testing", agegroup: "ADULT", sex: "ANY" },
  ...
  { testcode: "HIV screen", bodysite: "Venous blood", referencetext: "Negative", clinicalindication: "HIV screening; blood donor testing", agegroup: "ADULT", sex: "ANY" },
  ...
  { testcode: "CA 15-3", bodysite: "Venous blood", referencetext: "< 30 U/mL", panichigh: "100", clinicalindication: "Breast cancer monitoring; metastatic disease", agegroup: "ADULT", sex: "F" },
  { testcode: "CA 19-9", bodysite: "Venous blood", referencetext: "< 37 U/mL", panichigh: "1000", clinicalindication: "Pancreatic cancer; biliary cancer; GI malignancies", agegroup: "ADULT", sex: "ANY" },
  ...
  { testcode: "Crp titer", bodysite: "Venous blood", referencetext: "< 3.0 mg/L", panichigh: "10.0", clinicalindication: "Inflammation; infection; cardiovascular risk; autoimmune disease", agegroup: "ADULT", sex: "ANY" },
  
  // Immunology - Immunoglobulins
  { testcode: "IgM", bodysite: "Venous blood", referencemin: "40", referencemax: "230", paniclow: "20", panichigh: "400", clinicalindication: "Immunodeficiency; acute infection; B-cell disorders", agegroup: "ADULT", sex: "ANY" },
  { testcode: "IgG", bodysite: "Venous blood", referencemin: "700", referencemax: "1600", paniclow: "400", panichigh: "2000", clinicalindication: "Immunodeficiency; chronic infection; immune status", agegroup: "ADULT", sex: "ANY" },
  { testcode: "IgA", bodysite: "Venous blood", referencemin: "70", referencemax: "400", paniclow: "40", panichigh: "600", clinicalindication: "IgA deficiency; mucosal immunity", agegroup: "ADULT", sex: "ANY" },
  ...
  { testcode: "Blood for C/S (automated)", bodysite: "Venous blood", referencetext: "No growth", clinicalindication: "Automated blood culture; sepsis diagnosis", agegroup: "ADULT", sex: "ANY" },
  ...
  { testcode: "Stool for c/s (manual)", bodysite: "Stool", referencetext: "Normal flora", clinicalindication: "Bacterial gastroenteritis; diarrhea; food poisoning", agegroup: "ADULT", sex: "ANY" },
];
...
export async function POST() {
  try {
    ...
    return NextResponse.json({
      success: true,
      message: `Updated ${updated} test references with medical data`,
      updated,
      notFound,
