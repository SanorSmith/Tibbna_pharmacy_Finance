...
const comprehensiveTestReferences: TestReference[] = [
  ...
  { testcode: "MCV", testname: "Mean Corpuscular Volume", category: "Hematology", unit: "fL", agegroup: "NEO", sex: "ANY", referencemin: 96.0, referencemax: 108.0, paniclow: 60.0, panichigh: 130.0 },
  { testcode: "MCV", testname: "Mean Corpuscular Volume", category: "Hematology", unit: "fL", agegroup: "PED", sex: "ANY", referencemin: 75.0, referencemax: 87.0, paniclow: 60.0, panichigh: 120.0 },
  { testcode: "MCV", testname: "Mean Corpuscular Volume", category: "Hematology", unit: "fL", agegroup: "ADULT", sex: "ANY", referencemin: 80.0, referencemax: 100.0, paniclow: 60.0, panichigh: 120.0 },
  ...
  { testcode: "DBIL", testname: "Direct Bilirubin", category: "Liver Function", unit: "mg/dL", agegroup: "ALL", sex: "ANY", referencemin: 0.0, referencemax: 0.3, panichigh: 5.0 },
  { testcode: "ALB", testname: "Albumin", category: "Liver Function", unit: "g/dL", agegroup: "ALL", sex: "ANY", referencemin: 3.5, referencemax: 5.5, paniclow: 1.5, panichigh: 6.5 },
  { testcode: "TP", testname: "Total Protein", category: "Liver Function", unit: "g/dL", agegroup: "ALL", sex: "ANY", referencemin: 6.0, referencemax: 8.3, paniclow: 4.0, panichigh: 10.0 },
  { testcode: "ALP", testname: "Alkaline Phosphatase", category: "Liver Function", unit: "U/L", agegroup: "PED", sex: "ANY", referencemin: 100, referencemax: 400, panichigh: 1000 },
  { testcode: "ALP", testname: "Alkaline Phosphatase", category: "Liver Function", unit: "U/L", agegroup: "ADULT", sex: "ANY", referencemin: 30, referencemax: 120, panichigh: 500 },

  // LIPID PANEL
  { testcode: "CHOL", testname: "Total Cholesterol", category: "Lipid Panel", unit: "mg/dL", agegroup: "ADULT", sex: "ANY", referencemin: 0, referencemax: 200, panichigh: 400 },
  { testcode: "TRIG", testname: "Triglycerides", category: "Lipid Panel", unit: "mg/dL", agegroup: "ADULT", sex: "ANY", referencemin: 0, referencemax: 150, panichigh: 1000 },
  { testcode: "HDL", testname: "HDL Cholesterol", category: "Lipid Panel", unit: "mg/dL", agegroup: "ADULT", sex: "M", referencemin: 40, referencemax: 200, paniclow: 20 },
  { testcode: "HDL", testname: "HDL Cholesterol", category: "Lipid Panel", unit: "mg/dL", agegroup: "ADULT", sex: "F", referencemin: 50, referencemax: 200, paniclow: 25 },
  { testcode: "LDL", testname: "LDL Cholesterol", category: "Lipid Panel", unit: "mg/dL", agegroup: "ADULT", sex: "ANY", referencemin: 0, referencemax: 100, panichigh: 250 },
  ...
  { testcode: "T3", testname: "Triiodothyronine", category: "Thyroid", unit: "ng/dL", agegroup: "ADULT", sex: "ANY", referencemin: 80, referencemax: 200, paniclow: 40, panichigh: 300 },
  { testcode: "T4", testname: "Thyroxine", category: "Thyroid", unit: "µg/dL", agegroup: "ADULT", sex: "ANY", referencemin: 4.5, referencemax: 12.0, paniclow: 2.0, panichigh: 20.0 },

  // DIABETES MARKERS
  { testcode: "HBA1C", testname: "Hemoglobin A1c", category: "Diabetes", unit: "%", agegroup: "ADULT", sex: "ANY", referencemin: 4.0, referencemax: 5.6, panichigh: 14.0 },
  ...
  { testcode: "CK", testname: "Creatine Kinase", category: "Cardiac", unit: "U/L", agegroup: "ADULT", sex: "M", referencemin: 52, referencemax: 336, panichigh: 1000 },
  { testcode: "CK", testname: "Creatine Kinase", category: "Cardiac", unit: "U/L", agegroup: "ADULT", sex: "F", referencemin: 38, referencemax: 176, panichigh: 800 },
  ...
  // URINALYSIS
  { testcode: "URINE-PH", testname: "Urine pH", category: "Urinalysis", unit: "pH", agegroup: "ALL", sex: "ANY", referencemin: 4.5, referencemax: 8.0, paniclow: 4.0, panichigh: 9.0 },
  { testcode: "URINE-SG", testname: "Urine Specific Gravity", category: "Urinalysis", unit: "", agegroup: "ALL", sex: "ANY", referencemin: 1.005, referencemax: 1.030, paniclow: 1.001, panichigh: 1.040 },
...
export async function POST(request: Request) {
  try {
    ...
    console.log(`Seeding comprehensive test reference ranges for workspace: ${workspaceid}`);
    ...
    return NextResponse.json({
      success: true,
      message: `Successfully seeded ${inserted} test reference ranges, skipped ${skipped} duplicates`,
      inserted,
      skipped,
      total: comprehensiveTestReferences.length,
    });
  } catch (error) {
    console.error("Error seeding comprehensive test references:", error);
    return NextResponse.json(
