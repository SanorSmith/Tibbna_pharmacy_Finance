...
export const test_reference_ranges = pgTable("test_reference_ranges", {
	...
	agegroup: varchar("agegroup", { length: 20 }).default('ALL'::character varying).notNull(),
	sex: varchar("sex", { length: 10 }).default('ANY'::character varying).notNull(),
	...
	notes: text("notes"),
	isactive: varchar("isactive", { length: 1 }).default('Y'::character varying).notNull(),
...
export const invoice_returns = pgTable("invoice_returns", {
	...
	status: varchar("status", { length: 50 }).default('PENDING'::character varying),
...
export const leave_types = pgTable("leave_types", {
	...
	accrual_frequency: varchar("accrual_frequency", { length: 20 }).default('YEARLY'::character varying),
	...
	color: varchar("color", { length: 7 }).default('#3B82F6'::character varying),
...
export const leave_requests = pgTable("leave_requests", {
	...
	request_source: varchar("request_source", { length: 20 }).default('WEB'::character varying),
...
export const attendance_transactions = pgTable("attendance_transactions", {
	...
	source: varchar("source", { length: 20 }).default('DEVICE'::character varying),
	ip_address: inet("ip_address"),
	created_at: timestamp("created_at", { withTimezone: true, mode: 'string' }).defaultNow(),
	created_by: varchar("created_by", { length: 255 }),
},
...
export const daily_attendance = pgTable("daily_attendance", {
	...
	status: varchar("status", { length: 20 }).default('PRESENT'::character varying),
...
export const official_holidays = pgTable("official_holidays", {
	...
	color: varchar("color", { length: 7 }).default('#EF4444'::character varying),
	icon: varchar("icon", { length: 50 }),
	is_active: boolean("is_active").default(true),
	created_at: timestamp("created_at", { withTimezone: true, mode: 'string' }).defaultNow(),
	created_by: varchar("created_by", { length: 255 }),
...
export const employee_schedules = pgTable("employee_schedules", {
	...
	end_date: date("end_date"),
	schedule_type: varchar("schedule_type", { length: 20 }).default('REGULAR'::character varying),
	rotation_pattern: varchar("rotation_pattern", { length: 50 }),
	is_active: boolean("is_active").default(true),
	status: varchar("status", { length: 20 }).default('ACTIVE'::character varying),
	approved_by: uuid("approved_by"),
...
export const notifications = pgTable("notifications", {
	...
	category: varchar("category", { length: 50 }).default('LEAVE'::character varying),
...
export const notification_templates = pgTable("notification_templates", {
	...
	default_priority: varchar("default_priority", { length: 20 }).default('NORMAL'::character varying),
	is_active: boolean("is_active").default(true),
	created_at: timestamp("created_at", { withTimezone: true, mode: 'string' }).defaultNow(),
	updated_at: timestamp("updated_at", { withTimezone: true, mode: 'string' }).defaultNow(),
},
